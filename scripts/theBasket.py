...
class Basket:
    ...
    def depth_to_basket(self, depth_img):
        ...
        # selected_depth_array = np.mean(depth_img[self.basket[2]:self.basket_location[3],[self.basket[0]:self.basket_location[1]]])
    ...
    def get_basket_location(self, frame, color):
        ...
        x2, y2 = x1 + w, y1 + h
        self.basket_location = [x1, x2, y1, y2]
